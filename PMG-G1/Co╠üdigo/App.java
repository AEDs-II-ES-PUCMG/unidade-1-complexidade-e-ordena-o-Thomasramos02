...
public class App {
    ...
    static void localizarPedidosPremium() {
        ...
        if (pedidosOrdenadosPorValor == null || quantPedidos == 0) {
        ...
        int primeiroIndiceValido = quantPedidos;
        ...
        if (primeiroIndiceValido == quantPedidos) {
            System.out.println("Nenhum pedido premium encontrado para o corte informado.");
            return;
        }

        System.out.println("\nPedidos premium (valor final >= R$ " + String.format("%.2f", valorCorte) + "):");
        for (int i = primeiroIndiceValido; i < quantPedidos; i++) {
            System.out.println("------------------------------");
            System.out.println(pedidosOrdenadosPorValor[i]);
        }
    }

    static void atualizarPedidosOrdenadosPorValor() {
    ...
    static void ordenarPedidos() {
        ...
        if (ordenador != null) {
            ...
            atualizarPedidosOrdenadosPorValor();
        }
        ordenador = null;
    }
